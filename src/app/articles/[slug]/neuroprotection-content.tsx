...
import maximizeCircleIcon from "@/app/maximize-circle.svg";
  ...
  return (
    <section className={styles.neuroArticle}>
      ...
      <figure className={styles.diagramFigure}>
        ...
        >
          <Image src={maximizeCircleIcon} alt="" width={52} height={52} />
        </button>
        <Image
      ...
      <div className={styles.postImageContent}>
        <p className={styles.postImageText}>
          Внутриглазное давление (ВГД) является одним из наиболее важных факторов
          риска развития и прогрессирования глаукомы, и терапия, снижающая ВГД,
          по общему мнению, является наиболее изученной стратегией лечения,
          позволяющей замедлить или остановить ухудшение глаукоматозной
          оптиконейропатии.
        </p>
        <p className={styles.postImageText}>
          Хотя существует множество гипотензивных препаратов и хирургических
          методов, которые могут эффективно и результативно снизить ВГД, снижения
          ВГД, как правило, бывает недостаточно для предотвращения
        ...
        <p className={styles.postImageText}>
          ...
          прогрессировала, несмотря на снижение ВГД на 22,5% со среднего значения
          24,9 мм рт. ст. до 19,3 мм рт. ст.
        </p>
        <p className={styles.postImageText}>
        ...
        <p className={styles.postImageText}>
          ...
          прогрессирование заболевания, несмотря на снижение среднего значения ВГД
          до 10,6 мм рт. ст. в течение 5,6 лет наблюдения.
        </p>
        <p className={styles.postImageText}>
        ...
        <p className={styles.postImageText}>
          ...
          уделяют внимание изучению биомолекулярных механизмов выживания нейронов
          и разработке дальнейших нейропротекторных методов лечения в качестве
          дополнения к лечению, снижающему ВГД.
        </p>
      </div>

      <details className={styles.referencesAccordion} open>
        <summary className={styles.referencesSummary}>Список литературы:</summary>
