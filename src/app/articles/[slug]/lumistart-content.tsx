    ...
    >
      ...
      <p className={styles.clinicalBody}>
        *&nbsp;Данное исследование было открытым исследованием по оценке
        ...
        с предшествующего метода лечения:&nbsp;у 73,9&nbsp;% — недостаточный
        контроль; у 37,4&nbsp;% — непереносимость препарата; у 18,8&nbsp;% —
        прогрессирование заболевания; у 12,3&nbsp;% — несоблюдение режима
        лечения.
      </p>
